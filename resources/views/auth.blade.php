                ...
                <form class="form form-login" action="{{ route('login') }}" method="post">
                    ...
                    <fieldset>
                        ...
                        <input class="connexion__password font dyslexie" type="password"
                            placeholder="{{ __('auth.password') }}" name="password" id="password_connexion" required />
                        @error('password')
            ...
            <div class="form-wrapper @if ($baseActive == 'signup') is-active @endif">
                ...
                <form class="form form-signup" action="{{ route('signup') }}" method="post">
                    ...
                    <fieldset>
                        ...
                        <input class="inscription__name font dyslexie" type="name"
                        ...
                        <input class="inscription__password font dyslexie" type="password"
                            placeholder="{{ __('auth.password') }}" name="password" id="password_inscription" required />
                        @error('password')
                            <span class="inscription__error font dyslexie">{{ $message }}</span>
                        @enderror
                    </fieldset>
