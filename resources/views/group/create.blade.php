...
@section('content')
    ...
    <form class="group__form" action="{{ route('group.store') }}" method="post" enctype="multipart/form-data">
        ...
        <input class="group__form--input" maxlength="16" placeholder="{{__('forms.name')}}" type="text"
               name="name"
               required>

        <div class="group__form--range">
            <label class="group__form--range-label" for="max_members">{{__('group.max-members')}}</label>
        ...
        <div class="group__form--toggle">
            <label class="group__form--toggle-label" for="private">{{__('group.private')}}</label>
            <input class="group__form--toggle-input" type="checkbox" name="private">
        </div>

        <div class="group__form--icon">
            <label class="group__form--icon-label" for="groupIcon">{{__('group.icon-action')}}</label>
